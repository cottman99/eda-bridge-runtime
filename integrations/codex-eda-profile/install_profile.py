...
def render_profile(skills: list[tuple[Path, str]], keep_names: set[str]) -> str:
    lines = [
        ...
        '"eda.context.resolve", "eda.capabilities", "eda.submit", "eda.job.status", '
...
def install_profile(
    ...
    *,
    ...
    output.write_text(render_profile(skills, selected), encoding="utf-8", newline="\n")
